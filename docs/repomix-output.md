...
- Files matching these patterns are excluded: .cursor, docs, node_modules, .gitignore, .repomixignore, bun.lock, README.md, repomix.config.json, tsconfig.tsbuildinfo
